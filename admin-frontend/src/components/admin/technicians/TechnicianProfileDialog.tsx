  ...
  return (
    <DialogContent className="sm:max-w-[700px] max-h-[80vh] overflow-y-auto">
      <DialogHeader>
        ...
        <DialogDescription>View technician details and performance</DialogDescription>
      </DialogHeader>
        ...
        <div className="bg-gray-50 p-4 rounded-md">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Specialist: {technician.specialty}</p>
            </div>
          </div>
          ...
          <div className="mt-4">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium">{technician.performance}%</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border rounded-md p-4">
                  ...
                  <div className="text-2xl font-bold mt-1">{technician.averageTime}</div>
                </div>
                <div className="border rounded-md p-4">
              ...
              {[1, 2, 3, 4, 5].map((item) => (
                <div key={item} className="border rounded-md p-3">
                  ...
                  <p className="text-sm line-clamp-2">
                    {item % 2 === 0 ? 'Hardware issue resolved. Required replacement of faulty component.' : 
                     'Software configuration issue fixed. Updated system settings.'}
                  </p>
                  <div className="flex justify-between mt-2">
                    <div className="text-xs text-gray-500">Completed: May {item + 10}, 2025</div>
                    <div className="text-xs text-gray-500">Resolution time: {item + 1}h 20m</div>
                  </div>
                </div>
              ))}
            </div>
